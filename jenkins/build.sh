...
if [[ -z ${GT_BINDINGS_CROSS_COMPILATION} ]]; then
	GT_BINDINGS_CROSS_COMPILATION=OFF
fi
...
-DENABLE_X86:BOOL=$ENABLE_X86 \
-DENABLE_CUDA:BOOL=$ENABLE_CUDA \
-DENABLE_MC:BOOL=$ENABLE_MC \
...
-DGT_BINDINGS_CROSS_COMPILATION=$GT_BINDINGS_CROSS_COMPILATION \
../
