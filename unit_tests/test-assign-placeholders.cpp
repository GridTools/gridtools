...
#define BACKEND backend<Host, Naive >
    ...
    typedef gridtools::BACKEND::storage_type<float_type, gridtools::meta_storage<0, gridtools::layout_map<0,1,2>, false> >::type storage_type;
    typedef gridtools::BACKEND::temporary_storage_type<float_type, gridtools::meta_storage<0, gridtools::layout_map<0,1,2>, true> >::type tmp_storage_type;
