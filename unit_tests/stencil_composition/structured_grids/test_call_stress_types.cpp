...
class call_stress_types : public testing::Test {
  protected:
    using storage_info_t = gridtools::storage_traits<backend_t::target_t>::storage_info_t<0, 3>;
    using data_store_in1_t =
        gridtools::storage_traits<backend_t::target_t>::data_store_t<special_type<in1_tag>, storage_info_t>;
    using data_store_in2_t =
        gridtools::storage_traits<backend_t::target_t>::data_store_t<special_type<in2_tag>, storage_info_t>;
    using data_store_out_t =
        gridtools::storage_traits<backend_t::target_t>::data_store_t<special_type<out_tag>, storage_info_t>;
