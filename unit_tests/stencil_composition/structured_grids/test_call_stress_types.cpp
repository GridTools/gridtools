...
class call_stress_types : public testing::Test {
  protected:
    ...
    using data_store_in1_t =
        gridtools::storage_traits<backend_t::backend_target_t>::data_store_t<special_type<in1_tag>, storage_info_t>;
    using data_store_in2_t =
        gridtools::storage_traits<backend_t::backend_target_t>::data_store_t<special_type<in2_tag>, storage_info_t>;
