...
namespace gridtools {
    namespace {
        ...
        using storage_t = gridtools::storage_traits<backend_t::backend_target_t>::data_store_t<float_type, meta_ijkp_t>;
        using storage_buff_t =
            gridtools::storage_traits<backend_t::backend_target_t>::data_store_t<float_type, meta_kji_t>;
        using storage_out_t =
            gridtools::storage_traits<backend_t::backend_target_t>::data_store_t<float_type, meta_ij_t>;
