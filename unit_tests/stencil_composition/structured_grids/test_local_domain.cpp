...
typedef storage_traits<naive_backend_t::backend_target_t>::data_store_t<float_type, meta_ijk_t> storage_t;
typedef storage_traits<naive_backend_t::backend_target_t>::data_store_t<float_type, meta_kji_t> storage_buff_t;
