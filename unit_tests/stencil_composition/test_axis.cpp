...
TEST(test_axis, ctor) {
    using axis_t = axis<2, gridtools::axis<2, axis_config::offset_limit<level_offset_limit>>>;
...
TEST(test_axis, intervals) {
    using axis_t = axis<3, gridtools::axis<2, axis_config::offset_limit<level_offset_limit>>>;
