...
bool test_domain_indices() {
    ...
    typedef gridtools::backend<enumtype::Host,enumtype::Naive>::storage_type<float_type, storage_info<0,layout_map<0,1,2>,false> >::type storage_type;
    typedef gridtools::backend<enumtype::Host,enumtype::Naive>::temporary_storage_type<float_type, storage_info<0,layout_map<0,1,2>,true> >::type tmp_storage_type;
    ...
    storage_info<0, layout_map<0,1,2>, false > meta_(d1,d2,d3);
