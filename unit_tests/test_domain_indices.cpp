...
bool test_domain_indices() {
    ...
    typedef gridtools::backend<enumtype::Host,enumtype::Naive>::storage_type<float_type, storage_info<layout_map<0,1,2> > >::type storage_type;
    typedef gridtools::backend<enumtype::Host,enumtype::Naive>::temporary_storage_type<float_type, storage_info<layout_map<0,1,2> > >::type tmp_storage_type;
