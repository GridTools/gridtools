...
bool test_domain_indices() {
    ...
    typedef backend<enumtype::Host, GRIDBACKEND, enumtype::Naive>::
            storage_type<float_type, backend<enumtype::Host, GRIDBACKEND, enumtype::Naive>::storage_info<0,layout_map<0,1,2> > >::type storage_type;
    typedef backend<enumtype::Host, GRIDBACKEND, enumtype::Naive>::
            temporary_storage_type<float_type, backend<enumtype::Host, GRIDBACKEND, enumtype::Naive>::storage_info<0,layout_map<0,1,2> > >::type tmp_storage_type;
