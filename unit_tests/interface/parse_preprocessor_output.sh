...
# and "-o file" which woud be the output of the linker.
...
# removes everything before "class my_repository"
awk "/class my_repository/,0" $object_file | clang-format > $output_file
