...
namespace test_iterate_domain{
    ...
    bool static test(){
        ...
        typedef storage_info<0, layout_ijkp_t, false> meta_ijkp_t;
        typedef storage_info<0, layout_kji_t, false> meta_kji_t;
        typedef storage_info<0, layout_ij_t, false> meta_ij_t;
