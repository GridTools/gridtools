...
namespace test_iterate_domain{
    ...
    *in.get<2,0>()=20.;
    ...
    assert(it_domain(alias<accessor<0, range<0,0,0>, 6>, dimension<5> >::set<0>())==0.);
    assert(it_domain(alias<accessor<0, range<0,0,0>, 6>, dimension<5> >::set<1>())==1.);
    assert(it_domain(alias<accessor<0, range<0,0,0>, 6>, dimension<5> >::set<2>())==2.);
    assert(it_domain(alias<accessor<0, range<0,0,0>, 6>, dimension<6> >::set<1>())==10.);
    assert(it_domain(alias<accessor<0, range<0,0,0>, 6>, dimension<6>, dimension<5> >::set<1, 1>())==11.);
    assert(it_domain(alias<accessor<0, range<0,0,0>, 6>, dimension<6> >::set<2>())==20.);
    ...
    *buff.get<1,6>()=16.;
    ...
    assert(it_domain(alias<accessor<1, range<0,0,0>, 5>, dimension<4> >::set<0>())==0.);
    assert(it_domain(alias<accessor<1, range<0,0,0>, 5>, dimension<4> >::set<1>())==1.);
    assert(it_domain(alias<accessor<1, range<0,0,0>, 5>, dimension<4> >::set<2>())==2.);
    assert(it_domain(alias<accessor<1, range<0,0,0>, 5>, dimension<5> >::set<1>())==10.);
    assert(it_domain(alias<accessor<1, range<0,0,0>, 5>, dimension<5>, dimension<4> >::set<1, 1>())==11.);
    assert(it_domain(alias<accessor<1, range<0,0,0>, 5>, dimension<5>, dimension<4> >::set<1, 2>())==12.);
    assert(it_domain(alias<accessor<1, range<0,0,0>, 5>, dimension<5>, dimension<4> >::set<1, 3>())==13.);
    assert(it_domain(alias<accessor<1, range<0,0,0>, 5>, dimension<5>, dimension<4> >::set<1, 4>())==14.);
    assert(it_domain(alias<accessor<1, range<0,0,0>, 5>, dimension<5>, dimension<4> >::set<1, 5>())==15.);
    assert(it_domain(alias<accessor<1, range<0,0,0>, 5>, dimension<5>, dimension<4> >::set<1, 6>())==16.);
    ...
    *out.get<2,1>()=21.;
    ...
    assert(it_domain(accessor<2, range<0,0,0>, 4>(dimension<3>(1)))==1.);
    assert(it_domain(accessor<2, range<0,0,0>, 4>(dimension<4>(1)))==10.);
    assert(it_domain(accessor<2, range<0,0,0>, 4>(dimension<4>(1), dimension<3>(1)))==11.);
    assert(it_domain(accessor<2, range<0,0,0>, 4>(dimension<4>(2)))==20.);
    assert(it_domain(accessor<2, range<0,0,0>, 4>(dimension<4>(2), dimension<3>(1)))==21.);
    ...
    using in_1_1=alias<accessor<0, range<0,0,0>, 6>, dimension<6>, dimension<5> >::set<1, 1>;
    ...
    //check offsets for the space dimensions
    using buff_1_1=alias<accessor<1, range<0,0,0>, 5>, dimension<5>, dimension<4> >::set<1, 1>;
    ...
    using out_1=alias<accessor<2, range<0,0,0>, 4>, dimension<4>, dimension<3> >::set<1, 1>;
