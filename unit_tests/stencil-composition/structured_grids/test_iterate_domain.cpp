...
namespace test_iterate_domain{
    ...
    struct dummy_functor {
        typedef accessor<0, enumtype::in, extend<0,0,0,0>, 6> in;
        typedef accessor<1, enumtype::in, extend<0,0,0,0>, 5> buff;
        typedef accessor<2, enumtype::inout, extend<0,0,0,0>, 4> out;
    ...
    bool static test(){
        ...
        typedef iterate_domain_host<
            ...
            iterate_domain_arguments<
                ...
                boost::mpl::vector1<extend<0,0,0,0> >,
                boost::mpl::vector0<>,
                block_size<32,4>,
                gridtools::grid<axis>
                >
        ...
        *in.get<0,2>()=20.;
        ...
        assert(it_domain(alias<inout_accessor<0, extend<0,0,0,0>, 6>, dimension<5> >::set<0>())==0.);
        assert(it_domain(alias<inout_accessor<0, extend<0,0,0,0>, 6>, dimension<5> >::set<1>())==1.);
        assert(it_domain(alias<inout_accessor<0, extend<0,0,0,0>, 6>, dimension<5> >::set<2>())==2.);
        assert(it_domain(alias<inout_accessor<0, extend<0,0,0,0>, 6>, dimension<6> >::set<1>())==10.);
        assert(it_domain(alias<inout_accessor<0, extend<0,0,0,0>, 6>, dimension<6>, dimension<5> >::set<1, 1>())==11.);
        assert(it_domain(alias<inout_accessor<0, extend<0,0,0,0>, 6>, dimension<6> >::set<2>())==20.);
        ...
        *buff.get<6,1>()=16.;
        ...
        assert(it_domain(alias<accessor<1, enumtype::in,extend<0,0,0,0>, 5>, dimension<4> >::set<0>())==0.);
        assert(it_domain(alias<accessor<1, enumtype::in,extend<0,0,0,0>, 5>, dimension<4> >::set<1>())==1.);
        assert(it_domain(alias<accessor<1, enumtype::in,extend<0,0,0,0>, 5>, dimension<4> >::set<2>())==2.);
        assert(it_domain(alias<accessor<1, enumtype::in,extend<0,0,0,0>, 5>, dimension<5> >::set<1>())==10.);
        assert(it_domain(alias<accessor<1, enumtype::in,extend<0,0,0,0>, 5>, dimension<5>, dimension<4> >::set<1, 1>())==11.);
        assert(it_domain(alias<accessor<1, enumtype::in,extend<0,0,0,0>, 5>, dimension<5>, dimension<4> >::set<1, 2>())==12.);
        assert(it_domain(alias<accessor<1, enumtype::in,extend<0,0,0,0>, 5>, dimension<5>, dimension<4> >::set<1, 3>())==13.);
        assert(it_domain(alias<accessor<1, enumtype::in,extend<0,0,0,0>, 5>, dimension<5>, dimension<4> >::set<1, 4>())==14.);
        assert(it_domain(alias<accessor<1, enumtype::in,extend<0,0,0,0>, 5>, dimension<5>, dimension<4> >::set<1, 5>())==15.);
        assert(it_domain(alias<accessor<1, enumtype::in,extend<0,0,0,0>, 5>, dimension<5>, dimension<4> >::set<1, 6>())==16.);
        ...
        *out.get<1,2>()=21.;
        ...
        assert(it_domain(accessor<2, enumtype::inout,extend<0,0,0,0>, 4>())==0.);
        assert(it_domain(accessor<2, enumtype::inout,extend<0,0,0,0>, 4>(dimension<3>(1)))==1.);
        assert(it_domain(accessor<2, enumtype::inout,extend<0,0,0,0>, 4>(dimension<4>(1)))==10.);
        assert(it_domain(accessor<2, enumtype::inout,extend<0,0,0,0>, 4>(dimension<4>(1), dimension<3>(1)))==11.);
        assert(it_domain(accessor<2, enumtype::inout,extend<0,0,0,0>, 4>(dimension<4>(2)))==20.);
        assert(it_domain(accessor<2, enumtype::inout,extend<0,0,0,0>, 4>(dimension<4>(2), dimension<3>(1)))==21.);


        assert(it_domain(inout_accessor<2, extend<0,0,0,0>, 4>(0,0,0,0) ) == 0.);
        assert(it_domain(inout_accessor<2, extend<0,0,0,0>, 4>(0,0,1,0) ) == 1.);
        assert(it_domain(inout_accessor<2, extend<0,0,0,0>, 4>(0,0,0,1) ) == 10.);
        assert(it_domain(inout_accessor<2, extend<0,0,0,0>, 4>(0,0,1,1) ) == 11.);
        assert(it_domain(inout_accessor<2, extend<0,0,0,0>, 4>(0,0,0,2) ) == 20.);
        assert(it_domain(inout_accessor<2, extend<0,0,0,0>, 4>(0,0,1,2) ) == 21.);
        ...
        using in_1_1=alias<accessor<0, enumtype::inout,extend<0,0,0,0>, 6>, dimension<6>, dimension<5> >::set<1, 1>;
        ...
        using buff_1_1=alias<accessor<1, enumtype::inout,extend<0,0,0,0>, 5>, dimension<5>, dimension<4> >::set<1, 1>;
        ...
        using out_1=alias<inout_accessor<2, extend<0,0,0,0>, 4>, dimension<4>, dimension<3> >::set<1, 1>;
