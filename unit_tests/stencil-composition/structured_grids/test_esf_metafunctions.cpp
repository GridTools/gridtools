...
GRIDTOOLS_STATIC_ASSERT((std::is_same<boost::mpl::at<final_map, o0>::type, extent<-5, 11, -10, 10, -5, 13> >::type::value),
                          "o0 extent<-5, 11, -10, 10, -5, 13> ");
GRIDTOOLS_STATIC_ASSERT((std::is_same<boost::mpl::at<final_map, o1>::type, extent<-5, 9, -10, 8, -3, 10> >::type::value),
                          "o1 extent<-5, 9, -10, 8, -3, 10> ");
GRIDTOOLS_STATIC_ASSERT((std::is_same<boost::mpl::at<final_map, o2>::type, extent<-2, 8, -8, 7, -3, 8> >::type::value),
                          "o2 extent<-2, 8, -8, 7, -3, 8> ");
GRIDTOOLS_STATIC_ASSERT((std::is_same<boost::mpl::at<final_map, o3>::type, extent<-1, 5, -5, 7, 0, 6> >::type::value),
...
GRIDTOOLS_STATIC_ASSERT((std::is_same<boost::mpl::at<final_map, in0>::type, extent<-8, 11, -13, 13, -7, 13> >::type::value),
                          "in0 extent<-8, 11, -13, 13, -7, 13> ");
GRIDTOOLS_STATIC_ASSERT((std::is_same<boost::mpl::at<final_map, in1>::type, extent<-6, 12, -10, 12, -6, 15> >::type::value),
                          "in1 extent<-6, 12, -10, 12, -6, 15> ");
GRIDTOOLS_STATIC_ASSERT((std::is_same<boost::mpl::at<final_map, in2>::type, extent<-8, 14, -11, 12, -5, 14> >::type::value),
                          "in2 extent<-8, 14, -11, 12, -5, 14> ");
GRIDTOOLS_STATIC_ASSERT((std::is_same<boost::mpl::at<final_map, in3>::type, extent<-5, 10, -11, 10, -3, 10> >::type::value),
