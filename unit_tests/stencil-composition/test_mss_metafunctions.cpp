...
typedef gridtools::BACKEND::storage_type<float_type, meta_storage<0,layout_ijk_t, false> >::type storage_type;
typedef gridtools::BACKEND::temporary_storage_type<float_type, meta_storage<0,layout_ijk_t, true> >::type tmp_storage_type;
