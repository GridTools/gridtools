...
typedef gridtools::BACKEND::storage_type<float_type, storage_info<layout_ijk_t> >::type storage_type;
typedef gridtools::BACKEND::temporary_storage_type<float_type, storage_info<layout_ijk_t> >::type tmp_storage_type;
