...
typedef layout_map<2,1,0> layout_ijk_t;
    typedef gridtools::BACKEND::storage_type<float_type, storage_info<0,layout_ijk_t,false> >::type storage_type;
    typedef gridtools::BACKEND::temporary_storage_type<float_type, storage_info<0,layout_ijk_t,true> >::type tmp_storage_type;
