...
typedef detail::cache_impl<IJ, p_in, fill, USHRT_MAX, 0> cache1_t;
typedef detail::cache_impl<IJ, p_buff, fill, USHRT_MAX, 0> cache2_t;
typedef detail::cache_impl<K, p_out, local, USHRT_MAX, 0> cache3_t;
typedef detail::cache_impl<K, p_notin, local, USHRT_MAX, 0> cache4_t;
