...
namespace es_test{
    ...
    struct test_on_edges_functor {
        typedef in_accessor<0, icosahedral_topology_t::edges, radius<1> > in;
...
TEST(test_stencil_on_edges, run) {
    ...
    typedef boost::mpl::vector<p_in_edges, p_out_edges, p_i_edges, p_c_edges, p_j_edges, p_k_edges> accessor_list_t;

    gridtools::domain_type<accessor_list_t> domain(boost::fusion::make_vector(&in_edges, &out_edges, &i_edges, &c_edges, &j_edges, &k_edges) );
