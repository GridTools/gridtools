...
#ifndef __CUDACC__
    constexpr gridtools::meta_storage_base<0,layout_t,false> meta_{11u, 12u, 13u, 14u, 15u};
#else
    constexpr gridtools::meta_storage_base<0,layout_t,false> meta_{gridtools::static_uint<11>(), gridtools::static_uint<12>(), gridtools::static_uint<13>(), gridtools::static_uint<14>(), gridtools::static_uint<15>()};
#endif
