...
TEST(pointer_metafunctions, test_pointer) {
	...
	GRIDTOOLS_STATIC_ASSERT(is_wrap_pointer< wrap_pointer<double> >::value,	"is_wrap_pointer<wrap_pointer<double> > failed");
	...
	GRIDTOOLS_STATIC_ASSERT(!is_hybrid_pointer< wrap_pointer<double> >::value,	"is_hybrid_pointer<wrap_pointer<double> > failed");
	...
	GRIDTOOLS_STATIC_ASSERT(!is_wrap_pointer< hybrid_pointer<double> >::value,	"is_wrap_pointer<wrap_pointer<double> > failed");
	...
	GRIDTOOLS_STATIC_ASSERT(is_hybrid_pointer< hybrid_pointer<double> >::value,	"is_hybrid_pointer<wrap_pointer<double> > failed");
	...
	typedef wrap_pointer<int> w_pointer_type;
        ...
        typedef typename boost::mpl::if_<
             is_wrap_pointer<h_pointer_type>,
             wpf,
             typename boost::mpl::if_<
                 is_hybrid_pointer<h_pointer_type>,
                 hpf,
                 boost::mpl::void_
             >::type
        >::type h_storage_ptr_t;
        
	typedef typename boost::mpl::if_<
             is_wrap_pointer<w_pointer_type>,
             wpf,
             typename boost::mpl::if_<
                 is_hybrid_pointer<w_pointer_type>,
                 hpf,
                 boost::mpl::void_
             >::type
        >::type w_storage_ptr_t;
