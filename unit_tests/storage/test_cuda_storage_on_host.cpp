...
#ifdef __CUDACC__
	GRIDTOOLS_STATIC_ASSERT((boost::is_same<meta_data_t, meta_storage< meta_storage_aligned< meta_storage_base< static_int<0>, layout, false >, aligned<32>, halo<0,0,0> > > >::value), "type is wrong");
...
#else
	GRIDTOOLS_STATIC_ASSERT((boost::is_same<meta_data_t, meta_storage< meta_storage_aligned< meta_storage_base< static_int<0>, layout, false >, aligned<0>, halo<0,0,0> > > >::value), "type is wrong");
