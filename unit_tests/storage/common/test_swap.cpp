...
TEST(Storage, Swap) {
    using storage_info_t = gt::storage_traits<backend_t::target_t>::storage_info_t<0, 3>;
    using data_store_t = gt::storage_traits<backend_t::target_t>::data_store_t<double, storage_info_t>;
