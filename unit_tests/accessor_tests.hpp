 ...
 */
    bool test_trivial() {
        accessor<0, enumtype::inout, range<0,0,0,0>, 3> first(3,2,-1);
 ...
 */
    bool test_alternative1() {
        accessor<0, enumtype::inout, range<0,0,0,0>, 6> first(dimension<6>(-6), dimension<4>(12));
 ...
 */
    ...
    bool test_alternative2() {
        ...
        constexpr accessor<0, enumtype::inout, range<0,0,0,0>, 4> first(i-5, t+2, dimension<3>(8));
...
*/
    bool test_static_alias() {
        ...
        typedef accessor<0, enumtype::inout, range<0,0,0,0>, 15> arg_t;
