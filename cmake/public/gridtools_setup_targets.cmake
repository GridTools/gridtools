...
macro(_gt_setup_targets _config_mode clang_cuda_mode)
    ...
    if (GT_CUDA_TYPE STREQUAL NVCC-CUDA)
        ...
        if("CUDA" IN_LIST languages)
            _gt_add_library(${_config_mode} gridtools_nvcc)
    ...
    function(gridtools_cuda_setup type)
        ...
        elseif(type STREQUAL Clang-CUDA)
            ...
            target_compile_options(${_gt_namespace}gridtools_cuda INTERFACE -xcuda --cuda-path=${_gt_setup_root_dir})
    ...
    if (GT_CUDA_TYPE)
        _gt_add_library(${_config_mode} gridtools_cuda)
