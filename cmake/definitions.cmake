...
if(CUDA_AVAILABLE)
  ...
  if(NOT GT_USE_CLANG_CUDA AND ${CMAKE_CUDA_COMPILER_VERSION} VERSION_LESS 9.0 )
...
if( GT_ENABLE_BACKEND_CUDA )
  ...
  if(NOT GT_USE_CLANG_CUDA AND  ${CMAKE_CUDA_COMPILER_VERSION} VERSION_LESS_EQUAL 9.2 )
