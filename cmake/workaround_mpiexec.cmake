...
function(_fix_mpi_exec)
    ...
    set( MPITEST_HOST_ENVIRONMENT "$ENV{MPITEST_HOST_ENV}" CACHE STRING "Environment used for MPI Host tests in CTest" )
    set( MPITEST_CUDA_ENVIRONMENT "$ENV{MPITEST_CUDA_ENV}" CACHE STRING "Environment used for MPI CUDA tests in CTest" )
    set( TEST_HOST_ENVIRONMENT "$ENV{TEST_HOST_ENV}" CACHE STRING "Environment used for non-MPI Host tests in CTest" )
    set( TEST_CUDA_ENVIRONMENT "$ENV{TEST_CUDA_ENV}" CACHE STRING "Environment used for non-MPI CUDA tests in CTest" )
