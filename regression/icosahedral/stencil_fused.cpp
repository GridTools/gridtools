...
struct test_on_edges_functor {
    GT_DEFINE_ACCESSORS(
        GT_IN_ACCESSOR(in, enumtype::edges, extent<0, 1, 0, 1>), GT_INOUT_ACCESSOR(out, enumtype::cells));
...
struct test_on_cells_functor {
    GT_DEFINE_ACCESSORS(
        GT_IN_ACCESSOR(in, enumtype::cells, extent<-1, 1, -1, 1>), GT_INOUT_ACCESSOR(out, enumtype::cells));
