...
namespace gridtools {
  ...
  public:
    /** Constructor that takes the computing grid and initializes the
        patern.
     */
    all_to_all_halo(grid_type const& g)
      : proc_grid(g)
      , a2a(proc_grid.size())
    {}
    ...
    /** This function takes an array or vector of halos (sorted by
        ...
        \tparam arraytype1 type of the array of halos. This is required to have only the operator[] and the method size()
        \tparam arraytype2 type of the array of coordinates of the destination process. This is required to have only the operator[]
    ...
    /** This function takes an array or vector of halos (sorted by
        ...
        \param coords Array of vector of absolute coordinates of the process that from where the data will be received
     */
    template <typename arraytype1, typename arraytype2>
