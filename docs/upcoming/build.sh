...
#GT_doc_structure.md 
list_md_files="../user_manual/defines.md upcoming_main.md"
...
pandoc -s ../user_manual/highlight_js.md ${list_md_files} $PD_OPTIONS --from markdown --to json | python filters/include.py | python filters/note.py | pandoc --from json --to html $PD_OPTIONS > index.html
