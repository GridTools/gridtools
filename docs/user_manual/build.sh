...
pandoc -s highlight_js.md ${list_md_files} $PD_OPTIONS --from markdown --to json | python filters/include.py | python filters/note.py | pandoc --from json --to html $PD_OPTIONS > index.html
