        ...
        auto comp_ = make_computation<BACKEND>(
            domain_, grid_,
                make_mss(
                    ...
                    , define_caches(cache< IJ, local >(p_0_tmp(), p_1_tmp(), p_2_tmp(), p_3_tmp(), p_4_tmp(), p_5_tmp(), p_6_tmp(), p_7_tmp()))
                    , make_esf<functor_single_kernel>(p_0_tmp(), p_1_tmp(), p_2_tmp(), p_3_tmp(), p_4_tmp(), p_5_tmp(), p_6_tmp(), p_7_tmp(),
                                                      p_0_in(), p_1_in(), p_2_in(), p_3_in(), p_4_in(), p_5_in(), p_6_in(), p_7_in())
