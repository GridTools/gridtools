...
#define BACKEND backend<Host, GRIDBACKEND, Naive >
    ...
    bool test(uint_t x, uint_t y, uint_t z, uint_t t_steps) {
        ...
        typedef boost::mpl::
            vector< p_in_vertexes, p_out_vertexes, p_i_vertexes, p_c_vertexes, p_j_vertexes, p_k_vertexes >
                accessor_list_t;

        gridtools::domain_type< accessor_list_t > domain(boost::fusion::make_vector(
            &in_vertexes, &out_vertexes, &i_vertexes, &c_vertexes, &j_vertexes, &k_vertexes));
