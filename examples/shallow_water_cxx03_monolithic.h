...
#define BACKEND backend<Host, Naive >
    ...
    // comm_t comm(gridtools::boollist<3>(false,false,false), GCL_WORLD, 2);
        ...
        parallel_storage<sol_type, partitioner_t> sol(part, d1, d2, d3);
        parallel_storage<sol_type, partitioner_t> tmpx(part, d1, d2, d3);
        parallel_storage<sol_type, partitioner_t> tmpy(part, d1, d2, d3);
        parallel_storage<sol_type, partitioner_t> tmp3(part, d1, d2, d3);
