...
using gridtools::int_t;
    ...
    typedef hd_backend::storage_info<2,layout_scalar,gridtools::halo<2,0,0> > storage_info_scalar_t;
    typedef hd_backend::storage_info<0,layout_ijk,gridtools::halo<2,0,0> > storage_info_ijk_tmp_t;
    typedef hd_backend::storage_info<1,layout_ij,gridtools::halo<2,0,0> > storage_info_ij_tmp_t;
    typedef hd_backend::storage_info<2,layout_scalar,gridtools::halo<2,0,0> > storage_info_scalar_tmp_t;
