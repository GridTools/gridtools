...
int main(int argc, char **argv) {
    ...
    */
    ...
    bool error = false;
    {
        ...
        gt::boundary<gt::copy_boundary, backend_t::target_t>(halos, gt::copy_boundary{}).apply(out_s, in_s);
...

    {
        ...
        gt::boundary<gt::zero_boundary, backend_t::target_t>(halos, gt::zero_boundary{}).apply(out_s);
...

    {
        ...
        gt::boundary<gt::value_boundary<int>, backend_t::target_t>(halos, gt::value_boundary<int>{42}).apply(out_s);
