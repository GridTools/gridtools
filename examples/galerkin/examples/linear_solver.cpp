...
int main() {
    ...
    //![storages]
    // Problem matrix
    using matrix_storage_info_t=storage_info< __COUNTER__, layout_tt<5> >;// TODO: or 3,4
    ...
    // RHS vector
    using rhs_vector_storage_info_t=storage_info< __COUNTER__, layout_tt<4> >;// TODO: or 3
    ...
    // Unknowns vector
    using unk_vector_storage_info_t=storage_info< __COUNTER__, layout_tt<4> >;// TODO: or 3
