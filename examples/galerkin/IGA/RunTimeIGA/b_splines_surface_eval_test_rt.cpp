...
int main()
{
    ...
    typedef gridtools::BACKEND::storage_type<gridtools::float_type,layout_t_out>::type storage_type_curve_values;

    // Storage container allocation
    storage_type_csi csi(numPoints,1,1);
    storage_type_curve_values curve_values(numPoints,1,1,D);
