...
__global__ void m_packXLKernel(const value_type* __restrict__ d_data, 
                               ...
                               const gridtools::halo_descriptor* halo/*_g*/, int const ny, int const nz, const int field_index){
...
void m_packXL(array_t const& d_data_array, value_type** d_msgbufTab, int d_msgsize[27],
