...
namespace gridtools{
    ...
    /** @brief tuple of integers mixing runtime and compile time offsets
        ...
        The get_constexpr methods looks only in the compile-time tuple, it is static and always returns a constant expression.
     */
    ...
    template < typename ArgType, typename... Pair >
    constexpr typename offset_tuple_mixed< ArgType, Pair... >::offset_tuple_t offset_tuple_mixed< ArgType, Pair... >::s_tuple_constexpr;
