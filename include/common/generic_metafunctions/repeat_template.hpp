...
namespace gridtools{
    ...
    /**
       ...
       Usage example:
       I have a class template halo< .... >, and I want to fill it by repeating N times the same number H (represented as an MPL type)
       \verbatim
    ...
    struct repeat_template{
        typedef typename _impl::expand_recursively<typename _impl::expand_to_gt_integer_sequence<ushort_t, Constant::value, Length::value>::type, Lambda>::type type;
    };
    ...
    */
    ...
    struct repeat_template_c{
        typedef typename _impl::expand_recursively<typename _impl::expand_to_gt_integer_sequence<ushort_t, Constant, Length>::type, Lambda>::type type;
    };
}//namespace gridtools
