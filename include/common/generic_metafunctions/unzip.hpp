...
namespace gridtools{
    ...
    template <template <typename... T> class Container, typename First, typename ... UnzippedFirst, typename Second, typename ... UnzippedSecond,  typename ... Zipped>
    struct do_unzip<Container<UnzippedFirst...>, Container<UnzippedSecond...>, First, Second, Zipped ... >
    {
        typedef typename do_unzip<Container<UnzippedFirst ..., First>, Container<UnzippedSecond ..., Second>, Zipped ...>::first first;
        typedef typename do_unzip<Container<UnzippedFirst ..., First>, Container<UnzippedSecond ..., Second>, Zipped ...>::second second;
    };

    template <template <typename... T> class Container, typename First, typename Second, typename ... UnzippedFirst, typename ... UnzippedSecond>
