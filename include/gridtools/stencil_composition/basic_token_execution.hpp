...
namespace gridtools {
    ...
    template <class FromLevel, class ToLevel, class BackendTarget, class ExecutionEngine, class Grid>
    GT_FUNCTION int get_k_interval(BackendTarget, ExecutionEngine, Grid const &grid);
        ...
        struct run_f_on_interval_with_k_caches {
            ...
            GT_FUNCTION void operator()() const {
                ...
                const auto k_interval = get_k_interval<from_t, to_t>(
                    typename RunFunctorArguments::backend_target_t{}, execution_type_t{}, m_grid);
