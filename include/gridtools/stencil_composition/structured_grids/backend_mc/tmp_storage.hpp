...
namespace gridtools {
    namespace tmp_storage {
        ...
        uint_t get_i_size(backend_ids<target::mc> const &, uint_t block_size, uint_t /*total_size*/) {
        ...
        GT_FUNCTION int_t get_i_block_offset(
            backend_ids<target::mc> const &, uint_t /*block_size*/, uint_t /*block_no*/) {
            return false ? 0 : throw "should not be used";
        }

        template <class StorageInfo, class /*MaxExtent*/>
        uint_t get_j_size(backend_ids<target::mc> const &, uint_t block_size, uint_t /*total_size*/) {
