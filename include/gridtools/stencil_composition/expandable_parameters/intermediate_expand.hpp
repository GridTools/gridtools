...
namespace gridtools {
    ...
    namespace _impl {
        ...
        namespace expand_detail {
            ...
            void invoke_run(Intermediate &intermediate, Args &&args) {
                tuple_util::apply(run_f<Intermediate>{intermediate}, const_expr::forward<Args>(args));
            }
        } // namespace expand_detail
    }     // namespace _impl
    /**
    ...
    class intermediate_expand {
        ...
        intermediate_expand(Grid const &grid,
            ...
            : m_expandable_bound_arg_storage_pairs(const_expr::move(arg_refs.first)),
      ...
      public:
        ...
        intermediate_expand(Grid const &grid, BoundArgStoragePairsRefs &&arg_storage_pairs)
            ...
            // private constructor.
            : intermediate_expand(
                  grid, split_args_tuple<_impl::expand_detail::is_expandable>(const_expr::move(arg_storage_pairs))) {}
        ...
        void run(arg_storage_pair<Args, DataStores> const &... args) {
            ...
            auto expandable_args =
                std::tuple_cat(const_expr::move(bound_expandable_arg_refs), const_expr::move(arg_groups.first));
