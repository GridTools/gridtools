...
namespace gridtools {
    namespace expressions {
        ...
        */
        ...
        template <class Lhs, class Rhs>
        GT_FUNCTION GT_CONSTEXPR auto operator-(Lhs lhs, Rhs rhs) GT_AUTO_RETURN(make_expr(minus_f{}, lhs, rhs));

        template <class Arg>
        GT_FUNCTION GT_CONSTEXPR auto operator-(Arg arg) GT_AUTO_RETURN(make_expr(minus_f{}, arg));
        /** @} */
        /** @} */
    } // namespace expressions
} // namespace gridtools
