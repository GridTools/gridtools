...
namespace gridtools {
    namespace expressions {
        ...
        */
        ...
        template <class Lhs, class Rhs>
        GT_FUNCTION auto operator+(Lhs lhs, Rhs rhs) GT_AUTO_RETURN(make_expr(plus_f{}, lhs, rhs));

        template <class Arg>
        GT_FUNCTION auto operator+(Arg arg) GT_AUTO_RETURN(make_expr(plus_f{}, arg));
        /** @} */
        /** @} */
    } // namespace expressions
} // namespace gridtools
