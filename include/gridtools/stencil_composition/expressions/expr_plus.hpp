    ...
    namespace expressions {
        ...
        */
        ...
        GT_FUNCTION constexpr auto operator+(Lhs lhs, Rhs rhs)
            GT_AUTO_RETURN(make_expr(plus_f{}, const_expr::move(lhs), const_expr::move(rhs)));

        template <class Arg>
        GT_FUNCTION constexpr auto operator+(Arg arg) GT_AUTO_RETURN(make_expr(plus_f{}, const_expr::move(arg)));
        /** @} */
        /** @} */
    } // namespace expressions
} // namespace gridtools
