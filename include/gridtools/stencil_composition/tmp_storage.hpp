...
namespace gridtools {
    ...
    DataStore make_tmp_data_store(
        ...
        static constexpr auto backend = typename Backend::backend_target_t{};
    ...
    GT_META_DEFINE_ALIAS(needs_allocate_cached_tmp,
        meta::id,
        decltype(::gridtools::tmp_storage::needs_allocate_cached_tmp(typename Backend::backend_target_t{})));
