...
namespace gridtools {
    namespace impl {
         ...
         */
        template <uint_t Pos>
        GT_FUNCTION GT_HOST_CONSTEXPR long long compute_uuid_selector(int cnt) {
            return 0;
        }
        ...
        GT_FUNCTION GT_HOST_CONSTEXPR long long compute_uuid_selector(int cnt, int val0, Int... val) {
            return (cnt == 4)
                       ? 0
                       : ((val0 == 1)
