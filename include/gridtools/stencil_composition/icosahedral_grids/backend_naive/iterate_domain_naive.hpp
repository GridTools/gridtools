...
namespace gridtools {
    ...
    class iterate_domain_naive
        ...
        using base_t = iterate_domain<iterate_domain_naive<IterateDomainArguments>, IterateDomainArguments>;
      ...
      public:
        template <class Arg>
        GT_FORCE_INLINE iterate_domain_naive(Arg &&arg) : base_t(std::forward<Arg>(arg)) {}
