...
namespace gridtools {
    ...
    GT_FUNCTION on_neighbors<ValueType, enumtype::edges, Reduction, Accessors...> on_edges(
    ...
    template <typename Reduction, typename ValueType, typename... Accessors>
    GT_FUNCTION on_neighbors<ValueType, enumtype::cells, Reduction, Accessors...> on_cells(
        Reduction function, ValueType initial, Accessors...) {
    ...
    template <typename Reduction, typename ValueType, typename... Accessors>
    GT_FUNCTION on_neighbors<ValueType, enumtype::vertices, Reduction, Accessors...> on_vertices(
        Reduction function, ValueType initial, Accessors...) {
