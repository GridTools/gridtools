...
namespace gridtools {
    namespace extract_placeholders_impl_ {
        ...
        GT_META_DEFINE_ALIAS(flatten_trees, meta::flatten, (meta::transform<FlattenTree, Trees>));
    ...
    GT_META_DEFINE_ALIAS(extract_placeholders_from_mss,
        meta::dedup,
        (extract_placeholders_impl_::flatten_trees<Esfs, extract_placeholders_impl_::get_args>));
    ...
    GT_META_DEFINE_ALIAS(extract_placeholders_from_msses,
        meta::dedup,
        (extract_placeholders_impl_::flatten_trees<
