...
namespace gridtools {
    namespace sid {
        ...
        class delegate {
            ...
            friend constexpr auto sid_get_origin(delegate &obj) GT_AUTO_RETURN(get_origin(obj.m_impl));
            friend constexpr auto sid_get_strides(delegate const &obj) GT_AUTO_RETURN(get_strides(obj.m_impl));
