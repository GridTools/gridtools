...
namespace gridtools {
    ...
    struct data_view {
        static_assert(is_data_store<DataStore>::value, GT_INTERNAL_ERROR_MSG("Passed type is no data_store type"));
      ...
      public:
         ...
         * @return total size
         */
        GT_FUNCTION GT_CONSTEXPR int padded_total_length() const { return m_storage_info->padded_total_length(); }
         ...
         */
        template <uint_t Dim>
        GT_FUNCTION GT_CONSTEXPR int length() const {
         ...
         */
        template <uint_t Dim>
        GT_FUNCTION GT_CONSTEXPR int total_begin() const {
         ...
         */
        template <uint_t Dim>
        GT_FUNCTION GT_CONSTEXPR int begin() const {
         ...
         */
        template <uint_t Dim>
        GT_FUNCTION GT_CONSTEXPR int total_end() const {
         ...
         */
        template <uint_t Dim>
        GT_FUNCTION GT_CONSTEXPR int end() const {
