...
namespace gridtools {
    ...
    struct data_view {
      ...
      public:
         ...
         * @return total size
         */
        GT_FUNCTION int padded_total_length() const { return m_storage_info->padded_total_length(); }
         ...
         */
        template <uint_t Dim>
        GT_FUNCTION int total_begin() const {
         ...
         */
        template <uint_t Dim>
        GT_FUNCTION int total_end() const {
