...
namespace gridtools {
    ...
    struct storage_traits : gridtools::storage_traits_from_id<Target> {
      private:
        template <typename ValueType>
        using storage_t = typename gridtools::storage_traits_from_id<Target>::template select_storage<ValueType>::type;

      public:
        template <uint_t Id, uint_t Dims, typename Halo = zero_halo<Dims>>
        using storage_info_t =
            typename gridtools::storage_traits_from_id<Target>::template select_storage_info<Id, Dims, Halo>::type;
        ...
        using custom_layout_storage_info_t = typename gridtools::storage_traits_from_id<
            Target>::template select_custom_layout_storage_info<Id, LayoutMap, Halo>::type;
        ...
        using special_storage_info_t = typename gridtools::storage_traits_from_id<
            Target>::template select_special_storage_info<Id, Selector, Halo>::type;
        ...
        using storage_info_align_t = typename gridtools::storage_traits_from_id<
            Target>::template select_storage_info_align<Id, Dims, Halo, Align>::type;
        ...
        using custom_layout_storage_info_align_t = typename gridtools::storage_traits_from_id<
            Target>::template select_custom_layout_storage_info_align<Id, LayoutMap, Halo, Align>::type;
        ...
        using special_storage_info_align_t = typename gridtools::storage_traits_from_id<
            Target>::template select_special_storage_info_align<Id, Selector, Halo, Align>::type;
    };
