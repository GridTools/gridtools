    ...
    */
    ...
    namespace array_impl_ {
        ...
        struct getter {
            ...
            template <size_t I, typename T, size_t D>
            static GT_FUNCTION const T &get(const array<T, D> &arr) noexcept {
                GT_STATIC_ASSERT(I < D, "index is out of bounds");
                return arr.m_array[I];
            }
    ...
    GT_FUNCTION bool operator==(gridtools::array<T, D> const &a, gridtools::array<U, D> const &b) {
    ...
    template <size_t I, typename T, size_t D>
    GT_FUNCTION const T &get(const array<T, D> &arr) noexcept {
        GT_STATIC_ASSERT(I < D, "index is out of bounds");
        return arr.m_array[I];
    }
