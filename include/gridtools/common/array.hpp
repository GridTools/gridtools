    ...
    */
    ...
    namespace array_impl_ {
        ...
        struct getter {
            ...
            template <size_t I, typename T, size_t D>
            static GT_FUNCTION constexpr GT_META_CALL(const_ref, T) get(const array<T, D> &arr) noexcept {
                GT_STATIC_ASSERT(I < D, "index is out of bounds");
                return arr.m_array[I];
            }
    ...
    template <size_t I, typename T, size_t D>
    GT_FUNCTION constexpr GT_META_CALL(const_ref, T) get(const array<T, D> &arr) noexcept {
        GT_STATIC_ASSERT(I < D, "index is out of bounds");
        return arr.m_array[I];
    }
