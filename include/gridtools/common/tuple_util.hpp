...
positional_stencil_gpu
positional_stencil_gpu_horizontal
alignment_gpu
alignment_gpu_horizontal
whole_axis_access_gpu
whole_axis_access_gpu_horizontal
test_kcache_fill_gpu
test_kcache_fill_and_flush_gpu
test_kcache_flush_gpu
*/
...
#define GT_TUPLE_UTIL_FORWARD_GETTER_TO_MEMBER(class_name, member_name)                   \
    struct class_name##_tuple_util_getter {                                               \
        ...
        static GT_FORCE_INLINE constexpr decltype(auto) get(class_name const &obj) {      \
            return ::gridtools::tuple_util::get<I>(obj.member_name);                      \
        }                                                                                 \
        template <::std::size_t I>                                                        \
        static GT_FORCE_INLINE constexpr decltype(auto) get(class_name &obj) {            \
            return ::gridtools::tuple_util::get<I>(obj.member_name);                      \
        }                                                                                 \
        template <::std::size_t I>                                                        \
        static GT_FORCE_INLINE constexpr decltype(auto) get(class_name &&obj) {           \
            return ::gridtools::tuple_util::get<I>(::std::move(obj).member_name);         \
        }                                                                                 \
    };                                                                                    \
...
#define GT_STRUCT_TUPLE_IMPL_GETS_(s, name, i, elem)                                                        \
    ...
    static GT_FORCE_INLINE constexpr T const &get(name const &obj) {                                        \
        return obj.BOOST_PP_TUPLE_ELEM(1, elem);                                                            \
    }                                                                                                       \
    template <::std::size_t I, ::std::enable_if_t<I == i, int> = 0, class T = BOOST_PP_TUPLE_ELEM(0, elem)> \
    static GT_FORCE_INLINE constexpr T &get(name &obj) {                                                    \
        return obj.BOOST_PP_TUPLE_ELEM(1, elem);                                                            \
    }                                                                                                       \
    template <::std::size_t I, ::std::enable_if_t<I == i, int> = 0, class T = BOOST_PP_TUPLE_ELEM(0, elem)> \
    static GT_FORCE_INLINE constexpr T &&get(name &&obj) {                                                  \
...
namespace gridtools {
    namespace tuple_util {
        ...
        namespace traits {
            ...
            template <class T, size_t N>
            impl_::array_from_types tuple_from_types(std::array<T, N>);

            // getter

            // all `std` "tuple_like"s use `std::get`
            template <class... Ts>
            impl_::std_getter tuple_getter(std::tuple<Ts...>);
            template <class T, class U>
            impl_::std_getter tuple_getter(std::pair<T, U>);
            template <class T, size_t N>
            impl_::std_getter tuple_getter(std::array<T, N>);
        ...
        namespace impl_ {
            ...
            struct transform_elem_index_f {
                ...
                GT_FORCE_INLINE constexpr decltype(auto) operator()(Fun &&fun, Tups &&...tups) const {
                    return std::forward<Fun>(fun).template operator()<I>(get<I>(std::forward<Tups>(tups))...);
                }
            };
            ...
            struct generate_f<L<Generators...>, Res> {
                template <class... Args>
                GT_FORCE_INLINE constexpr Res operator()(Args &&...args) const {
            ...
            struct transform_index_f {
                template <class... Args>
                using get_results_t = meta::transform<get_fun_result_index<Fun>::template apply, Args...>;

                Fun m_fun;

                template <class Tup, class... Tups>
                GT_FORCE_INLINE constexpr auto operator()(Tup &&tup, Tups &&...tups) const {
                    using indices_t = meta::make_indices<size<std::decay_t<Tup>>>;
                    using res_t = from_types<Tup, get_results_t<indices_t, get_accessors<Tup>, get_accessors<Tups>...>>;
            ...
            struct add_index_arg_f {
                ...
                GT_FORCE_INLINE constexpr auto operator()(Args &&...args) const
            ...
            struct for_each_adaptor_f {
                Fun m_fun;
                template <size_t I, class... Args>
                GT_FORCE_INLINE constexpr meta::lazy::id<void> operator()(Args &&...args) const {
            ...
            struct apply_to_elements_f<L<Is...>> {
                template <class Fun, class... Tups>
                GT_FORCE_INLINE constexpr decltype(auto) operator()(Fun &&fun, Tups &&...tups) const {
                    return std::forward<Fun>(fun)(get<Is::value>(std::forward<Tups>(tups))...);
                }
            };
            ...
            struct for_each_in_cartesian_product_impl_f<Outer<Inners...>> {
                template <class Fun, class... Tups>
                GT_FORCE_INLINE constexpr void operator()(Fun &&fun, Tups &&...tups) const {
            ...
            struct for_each_in_cartesian_product_f {
                Fun m_fun;
                template <class... Tups>
                GT_FORCE_INLINE constexpr void operator()(Tups &&...tups) const {
            ...
            struct skip_me {
                template <class T>
                GT_FORCE_INLINE constexpr skip_me(T &&) {}
            };
            ...
            struct select_arg_f<std::index_sequence<IndicesToSkip...>> {
                ...
                GT_FORCE_INLINE constexpr T &&operator()(skip_me_type<IndicesToSkip> &&..., T &&obj, Ts &&...) const {
            ...
            struct concat_f {
                ...
                struct generator_f {
                    template <class... Tups>
                    GT_FORCE_INLINE constexpr decltype(auto) operator()(Tups &&...tups) const {
                        return get<InnerI::value>(
                ...
                using get_inner_generators =
                    meta::transform<meta::curry<generator_f, OuterI>::template apply, meta::make_indices_for<InnerTup>>;

                template <class... Tups>
                GT_FORCE_INLINE constexpr auto operator()(Tups &&...tups) const {
                    using accessors_t = meta::transform<get_accessors, meta::list<Tups...>>;
                    using res_t = typename ResultMaker::template apply<meta::flatten<accessors_t>, meta::list<Tups...>>;
            ...
            struct flatten_f {
                ...
                struct generator_f {
                    template <class Tup>
                    GT_FORCE_INLINE constexpr decltype(auto) operator()(Tup &&tup) const {
                        return get<InnerI::value>(get<OuterI::value>(std::forward<Tup>(tup)));
                    }
                };
                ...
                template <class Tup>
                GT_FORCE_INLINE constexpr auto operator()(Tup &&tup) const {
            ...
            struct drop_front_f {
                ...
                GT_FORCE_INLINE constexpr Res operator()(Tup &&tup) const {
                    using generators =
            ...
            struct push_back_impl_f<L<Int, Is...>, Res> {
                ...
                GT_FORCE_INLINE constexpr Res operator()(Tup &&tup, Args &&...args) const {
            ...
            struct push_front_impl_f<L<Int, Is...>, Res> {
                template <class Tup, class... Args>
                GT_FORCE_INLINE constexpr Res operator()(Tup &&tup, Args &&...args) const {
                    return Res{std::forward<Args>(args)..., get<Is>(std::forward<Tup>(tup))...};
                }
            };
            ...
            struct pop_back_impl_f<L<Int, Is...>, Res> {
                template <class Tup>
                GT_FORCE_INLINE constexpr Res operator()(Tup &&tup) const {
                    return Res{get<Is>(std::forward<Tup>(tup))...};
                }
            };
            ...
            struct pop_front_impl_f<L<Int, Is...>, Res> {
                template <class Tup>
                GT_FORCE_INLINE constexpr Res operator()(Tup &&tup) const {
                    return Res{get<Is + 1>(std::forward<Tup>(tup))...};
                }
            };
            ...
            struct fold_f {
                ...
                GT_FORCE_INLINE constexpr State impl(State &&state, Tup &&) const {
                    return state;
                }

                template <size_t I, size_t N, class State, class Tup, std::enable_if_t<I + 1 == N, int> = 0>
                GT_FORCE_INLINE constexpr decltype(auto) impl(State &&state, Tup &&tup) const {
                    return m_fun(std::forward<State>(state), get<I>(std::forward<Tup>(tup)));
                }

                template <size_t I, size_t N, class State, class Tup, std::enable_if_t<I + 2 == N, int> = 0>
                GT_FORCE_INLINE constexpr decltype(auto) impl(State &&state, Tup &&tup) const {
                    return m_fun(m_fun(std::forward<State>(state), get<I>(std::forward<Tup>(tup))),
                        get<I + 1>(std::forward<Tup>(tup)));
                }

                template <size_t I, size_t N, class State, class Tup, std::enable_if_t<I + 3 == N, int> = 0>
                GT_FORCE_INLINE constexpr decltype(auto) impl(State &&state, Tup &&tup) const {
                    return m_fun(m_fun(m_fun(std::forward<State>(state), get<I>(std::forward<Tup>(tup))),
                                     get<I + 1>(std::forward<Tup>(tup))),
                ...
                GT_FORCE_INLINE constexpr decltype(auto) impl(State &&state, Tup &&tup) const {
                    return m_fun(m_fun(m_fun(m_fun(std::forward<State>(state), get<I>(std::forward<Tup>(tup))),
                                           get<I + 1>(std::forward<Tup>(tup))),
                                     get<I + 2>(std::forward<Tup>(tup))),
                ...
                GT_FORCE_INLINE constexpr Res impl(State &&state, Tup &&tup) const {
                    return impl<I + 5, N>(
                        m_fun(m_fun(m_fun(m_fun(m_fun(std::forward<State>(state), get<I>(std::forward<Tup>(tup))),
                                              get<I + 1>(std::forward<Tup>(tup))),
                                        get<I + 2>(std::forward<Tup>(tup))),
                                  get<I + 3>(std::forward<Tup>(tup))),
                            get<I + 4>(std::forward<Tup>(tup))),
                        std::forward<Tup>(tup));
                }
                ...
                template <class State,
                    ...
                    class Accessors = get_accessors<Tup>,
                    class Res = meta::foldl<meta_fun, State, Accessors>>
                GT_FORCE_INLINE constexpr Res operator()(State &&state, Tup &&tup) const {
                    return impl<0, size<std::decay_t<Tup>>::value>(std::forward<State>(state), std::forward<Tup>(tup));
                }
            ...
            struct implicit_convert_to_f {
                ...
                template <class Tup>
                GT_FORCE_INLINE constexpr To operator()(Tup &&tup) const {
                    return get<Index::value>(std::forward<Tup>(tup));
                }
            };
            ...
            struct transpose_f {
                ...
                GT_FORCE_INLINE constexpr std::enable_if_t<tuple_util::size<std::decay_t<Tup>>::value == 0> operator()(
                    Tup &&) const {
                    static_assert(
                        tuple_util::size<std::decay_t<Tup>>::value, "tuple_util::transpose input should not be empty");
                }
            ...
            struct insert_tup_generator_f {
                ...
                GT_FORCE_INLINE constexpr decltype(auto) operator()(Tup &&tup, Val &&) const {
            ...
            struct insert_val_generator_f {
                ...
                template <class Tup, class Val>
                GT_FORCE_INLINE constexpr Val operator()(Tup &&, Val &&val) const {
            ...
            GT_FORCE_INLINE constexpr decltype(auto) apply_impl(Fun &&f, Tup &&tup, std::index_sequence<Is...>) {
                return std::forward<Fun>(f)(get<Is>(std::forward<Tup>(tup))...);
            }
        } // namespace impl_
        ...
        GT_FORCE_INLINE constexpr auto transform(Fun &&fun, Tup &&tup, Tups &&...tups) {
            return impl_::transform_f<Fun>{{std::forward<Fun>(fun)}}(
         ...
         */
        template <class Fun>
        GT_FORCE_INLINE constexpr impl_::transform_f<Fun> transform(Fun fun) {
            return {std::move(fun)};
        }

        template <class Fun, class Tup, class... Tups>
        GT_FORCE_INLINE constexpr auto transform_index(Fun &&fun, Tup &&tup, Tups &&...tups) {
            return impl_::transform_index_f<Fun>{std::forward<Fun>(fun)}(
                std::forward<Tup>(tup), std::forward<Tups>(tups)...);
        }

        template <class Fun>
        GT_FORCE_INLINE constexpr impl_::transform_index_f<Fun> transform_index(Fun fun) {
            return {std::move(fun)};
        }
         ...
         */
        template <class Fun, class Tup, class... Tups>
        GT_FORCE_INLINE constexpr void for_each(Fun &&fun, Tup &&tup, Tups &&...tups) {
            transform_index(impl_::for_each_adaptor_f<Fun>{std::forward<Fun>(fun)},
                std::forward<Tup>(tup),
         ...
         */
        template <class Fun>
        GT_FORCE_INLINE constexpr impl_::transform_index_f<impl_::for_each_adaptor_f<Fun>> for_each(Fun fun) {
            return {{std::move(fun)}};
        }

        template <class Fun, class Tup, class... Tups>
        GT_FORCE_INLINE constexpr void for_each_index(Fun &&fun, Tup &&tup, Tups &&...tups) {
            transform_index(impl_::for_each_index_adaptor_f<Fun>{std::forward<Fun>(fun)},
                std::forward<Tup>(tup),
                std::forward<Tups>(tups)...);
        }

        template <class Fun>
        GT_FORCE_INLINE constexpr impl_::transform_index_f<impl_::for_each_index_adaptor_f<Fun>> for_each_index(
            Fun fun) {
            return {{std::move(fun)}};
        }
         ...
         */
        template <class Fun, class Tup, class... Tups>
        GT_FORCE_INLINE constexpr void for_each_in_cartesian_product(Fun &&fun, Tup &&tup, Tups &&...tups) {
            impl_::for_each_in_cartesian_product_f<Fun>{std::forward<Fun>(fun)}(
                std::forward<Tup>(tup), std::forward<Tups>(tups)...);
        }

        template <class Fun>
        GT_FORCE_INLINE constexpr impl_::for_each_in_cartesian_product_f<Fun> for_each_in_cartesian_product(Fun fun) {
            return {std::move(fun)};
        }
         ...
         */
        DEFINE_FUNCTOR_INSTANCE(concat, impl_::concat_f<impl_::default_concat_result_maker_f>);
         ...
         */
        template <class ResultMaker>
        DEFINE_TEMPLATED_FUNCTOR_INSTANCE(concat_ex, impl_::concat_f<ResultMaker>);
         ...
         * @endcode
         */
        DEFINE_FUNCTOR_INSTANCE(flatten, impl_::flatten_f<impl_::default_concat_result_maker_f>);

        /*
         * Extended variation of flatten. See concat_ex comments
         */
        template <class ResultMaker>
        DEFINE_TEMPLATED_FUNCTOR_INSTANCE(flatten_ex, impl_::flatten_f<ResultMaker>);
        ...
        GT_FORCE_INLINE constexpr Res generate(Args &&...args) {
            return impl_::generate_f<Generators, Res>{}(std::forward<Args>(args)...);
        }
         ...
         */
        template <size_t N>
        DEFINE_TEMPLATED_FUNCTOR_INSTANCE(drop_front, impl_::drop_front_f<N>);
         ...
         * @endcode
         */
        DEFINE_FUNCTOR_INSTANCE(push_back, impl_::push_back_f);

        /**
         * @brief Appends elements to a tuple from the front.
         */
        DEFINE_FUNCTOR_INSTANCE(push_front, impl_::push_front_f);

        /**
         * @brief Removes elements to a tuple from the front.
         */
        DEFINE_FUNCTOR_INSTANCE(pop_front, impl_::pop_front_f);

        /**
         * @brief Removes elements to a tuple from the back.
         */
        DEFINE_FUNCTOR_INSTANCE(pop_back, impl_::pop_back_f);
        ...
        GT_FORCE_INLINE constexpr decltype(auto) fold(Fun &&fun, Arg &&arg, Args &&...args) {
            return impl_::fold_f<Fun>{std::forward<Fun>(fun)}(std::forward<Arg>(arg), std::forward<Args>(args)...);
        }
         ...
         */
        DEFINE_FUNCTOR_INSTANCE(transpose, impl_::transpose_f);
         ...
         * @endcode
         */
        DEFINE_FUNCTOR_INSTANCE(deep_copy, impl_::transform_f<clone>);
        ...
        GT_FORCE_INLINE constexpr decltype(auto) apply(Fun &&fun, Tup &&tup) {
            return impl_::apply_impl(std::forward<Fun>(fun),
                std::forward<Tup>(tup),
        ...
        //
        template <template <class...> class L, class... Ts>
        GT_FORCE_INLINE constexpr L<Ts &...> tie(Ts &...elems) {
            return L<Ts &...>{elems...};
        }
...
#endif
            >
        GT_FORCE_INLINE constexpr impl_::convert_to_f<impl_::to_tuple_converter_helper<L>> convert_to() {
            return {};
        }
    ...
    (__CUDACC_VER_MAJOR__ < 11 || __CUDACC_VER_MAJOR__ == 11 && __CUDACC_VER_MINOR__ <= 5)
            ...
            ,
            class Tup>
        GT_FORCE_INLINE constexpr auto convert_to(Tup &&tup) {
            return impl_::convert_to_f<impl_::to_tuple_converter_helper<L>>{}(std::forward<Tup>(tup));
        }

        template <template <class, size_t> class Arr, class D = void>
        GT_FORCE_INLINE constexpr impl_::convert_to_f<impl_::to_array_converter_helper<Arr, D>> convert_to() {
            return {};
        }

        template <template <class, size_t> class Arr, class D = void, class Tup>
        GT_FORCE_INLINE constexpr auto convert_to(Tup &&tup) {
            return (impl_::convert_to_f<impl_::to_array_converter_helper<Arr, D>>{}(std::forward<Tup>(tup)));
        }

        DEFINE_FUNCTOR_INSTANCE(reverse, impl_::reverse_f);

        template <size_t I, class Val>
        GT_FORCE_INLINE constexpr impl_::insert_f<I, Val> insert(Val &&val) {
            return {std::forward<Val>(val)};
        }

        template <size_t I, class Val, class Tup>
        GT_FORCE_INLINE constexpr auto insert(Val &&val, Tup &&tup) {
