...
namespace gridtools {
    ...
    namespace impl_ {
        ...
        struct tuple_leaf_getter {
            template <size_t I, class T>
            static constexpr GT_FUNCTION const_ref<T> get(tuple_leaf<I, T, false> const &obj) noexcept {
                return obj.m_value;
            }
            ...
            template <size_t I, class T>
            static constexpr GT_FUNCTION const_ref<T> get(tuple_leaf<I, T, true> const &obj) noexcept {
                return obj;
            }
    ...
    class tuple {
      ...
      public:
        ...
        constexpr GT_FUNCTION tuple(const_ref<Ts>... args) noexcept : m_impl(args...) {}
    ...
    class tuple<T> {
        ...
        struct getter {
            ...
            static constexpr GT_FUNCTION const_ref<T> get(tuple const &obj) noexcept {
                return obj.m_value;
            }
      ...
      public:
        ...
        constexpr GT_FUNCTION tuple(const_ref<T> arg) noexcept : m_value(arg) {}
