...
namespace gridtools {
    ...
    namespace impl_ {
        ...
        struct tuple_leaf_getter {
            template <size_t I, class T>
            static GT_FUNCTION T const &get(tuple_leaf<I, T, false> const &obj) noexcept {
                return obj.m_value;
            }
            ...
            template <size_t I, class T>
            static GT_FUNCTION T const &get(tuple_leaf<I, T, true> const &obj) noexcept {
                return obj;
            }
    ...
    class tuple {
        ...
        struct getter {
            template <size_t I>
            static GT_FUNCTION auto get(tuple const &obj) noexcept GT_AUTO_RETURN(
    ...
    class tuple<T> {
        ...
        struct getter {
            ...
            static GT_FUNCTION T const &get(tuple const &obj) noexcept {
                return obj.m_value;
            }
