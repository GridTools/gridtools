...
namespace gridtools {
    ...
    */
    ...
    struct boollist {
      ...
      public:
        GT_FUNCTION uint_t const &size() const { return m_size; }

        GT_FUNCTION bool const &value(uint_t const &id) const { return m_value[id]; }
        GT_FUNCTION array<bool, I> const &value() const { return m_value; }
