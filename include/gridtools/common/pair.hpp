...
namespace gridtools {
    ...
    */
    ...
    template <typename T1, typename T2>
    GT_FUNCTION bool operator==(const pair<T1, T2> &lhs, const pair<T1, T2> &rhs) {
    ...
    template <typename T1, typename T2>
    GT_FUNCTION pair<T1, T2> make_pair(T1 t1_, T2 t2_) {
    ...
    namespace pair_impl_ {
        ...
        struct pair_get<0> {
            template <typename T1, typename T2>
            static GT_FUNCTION const T1 &const_get(const pair<T1, T2> &p) noexcept {
                return p.first;
            }
            template <typename T1, typename T2>
        ...
        struct pair_get<1> {
            template <typename T1, typename T2>
            static GT_FUNCTION const T2 &const_get(const pair<T1, T2> &p) noexcept {
                return p.second;
            }
            template <typename T1, typename T2>
        ...
        struct getter {
            ...
            static GT_FUNCTION auto get(pair<T1, T2> &p) noexcept GT_AUTO_RETURN(pair_get<I>::get(p));
    ...
    template <size_t I, class T1, class T2>
    GT_FUNCTION auto get(pair<T1, T2> &p) noexcept GT_AUTO_RETURN(pair_impl_::pair_get<I>::get(p));
