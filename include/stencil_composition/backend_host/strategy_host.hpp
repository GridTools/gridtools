...
#include "stencil_composition/backend_host/execute_kernel_functor_host.hpp"
    ...
    */
    ...
    struct strategy_from_id_host< enumtype::Naive > {
        ...
        struct get_tmp_storage_info {
            ...
            typedef meta_storage< meta_storage_aligned< meta_storage_base< Index::value, Layout, true >, Alignment, Halo > > type;
        };
