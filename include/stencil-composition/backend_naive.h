...
*/
        ...
        /**@brief Traits struct, containing the types which are specific for the host backend, to be used in \ref gridtools::backend*/
        template<>
        struct backend_from_id<enumtype::Host>
        {
            /**@brief typedef for the host storage*/
            template <typename ValueType, typename Layout>
            struct storage_traits{
                typedef storage<ValueType, Layout> storage_t;
            };

            /**@brief typedef for the host backend type*/
            template <typename Arguments>
            ...
            /**@brief version of for_each for the Host backend*/
