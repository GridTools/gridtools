...
namespace gridtools{
    ...
    template <uint_t ID, enumtype::intend Intend, typename LocationType, typename Radius, typename ArgsMap >
    struct remap_accessor_type<accessor<ID, Intend, LocationType, Radius>, ArgsMap >
    {
