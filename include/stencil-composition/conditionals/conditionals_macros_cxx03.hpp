...
#define _MAKE_COMPUTATION_IMPL(z, n, nil)                                                                            \
    ...
    _POINTER_ make_computation_impl(Domain &domain, const Grid &grid, BOOST_PP_ENUM(BOOST_PP_INC(n), _PAIR_, Mss)) { \
        ...
        typedef intermediate< Backend,                                                                               \
            ...
            Domain, Grid, conditionals_set_t, Positional > intermediate_t;                                           \
