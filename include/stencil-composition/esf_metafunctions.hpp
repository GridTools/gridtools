...
/**
   ...
   from false_type), or map between placeholders in this ESF and the extends
...
struct esf_args
{
    ...
    typedef typename boost::mpl::if_<
        Pred,
        typename Esf::args_with_extends,
...
/**
   ...
   placeholder and extend (if Pred derives from true_type)
 */
    ...
    struct apply {
        ...
        typedef typename boost::mpl::if_<
            ...
            typename boost::mpl::pair<
                placeholder_type,
                typename boost::mpl::at<typename Esf::args_with_extends, placeholder_type>::type>::type,
...
/**
    ...
    placeholders and extends that corresponds to temporary fields that are written by EsfF.
 */
...
/**
    ...
    If Pred derives from true_type, ::type provide a mpl::vector of pairs of
    placeholders and extends that corresponds to fields that are read by EsfF.
 */
template <typename EsfF, typename Pred = boost::false_type>
...
/**
    ...
    If Pred derives from true_type, ::type provide a mpl::vector of pairs of
    placeholders and extends that corresponds to fields (temporary or not) that are
    written by EsfF.
 */
template <typename EsfF, typename Pred = boost::false_type>
