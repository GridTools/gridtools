...
namespace gridtools {
    ...
    struct call {
        ...
        with(Evaluator const& eval, Args & ...) {
            ...
            Functor::Do(function_aggregator
                        ...
                        result_type,
                        _impl::_get_index_of_first_non_const<Functor>::value>(eval, result), Region());
    ...
    */
    ...
    struct function_aggregator_procedure {
        ...
        typedef typename boost::fusion::result_of::as_vector<typename v_item_to_fusion_vector<PassedArguments>::type>::type accessors_list_t;
        CallerAggregator const& m_caller_aggregator;
        accessors_list_t const& m_accessors_list;
        ...
        GT_FUNCTION
        constexpr
        typename boost::enable_if_c<not _impl::is_non_accessor<typename Accessor::index_type, non_accessor_indices>::value, typename CallerAggregator::value_type>::type
        operator()(Accessor const& accessor) const {
            return m_caller_aggregator
        ...
        GT_FUNCTION
        constexpr
        typename boost::enable_if_c<_impl::is_non_accessor<typename Accessor::index_type, non_accessor_indices>::value, typename CallerAggregator::value_type>::type &
        operator()(Accessor const&) const {
            // std::cout << "Giving the ref (OutArg=" << OutArg << ") " << m_result << std::endl;
