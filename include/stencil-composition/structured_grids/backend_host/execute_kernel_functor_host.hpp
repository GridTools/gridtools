        ...
        */
        ...
        struct execute_kernel_functor_host
        {
            ...
            */
            ...
            typedef typename RunFunctorArguments::reduction_data_t::reduction_type_t reduction_type_t;

        private:
                const local_domain_t& m_local_domain;
                const grid_t& m_grid;
                const reduction_type_t& m_initial_reduction_value;
        ...
        public:
            ...
            */
            explicit execute_kernel_functor_host(const local_domain_t& local_domain, const grid_t& grid,
                   const reduction_type_t& reduction_initial_value, const uint_t first_i, const uint_t first_j,
                   const uint_t last_i, const uint_t last_j, const uint_t block_idx_i, const uint_t block_idx_j)
                : m_local_domain(local_domain)
                , m_grid(grid)
                , m_initial_reduction_value(reduction_initial_value)
#ifdef CXX11_ENABLED
...
#pragma omp critical
                ...
                iterate_domain_t it_domain(m_local_domain, m_initial_reduction_value);
