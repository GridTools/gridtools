        ...
        struct compute_extents_of {
            ...
            struct for_mss {
                ...
                struct populate_map {
                    ...
                    GRIDTOOLS_STATIC_ASSERT((check_all_extents_are<outputs, extent< > >::type::value), "Extents of the outputs of ESFs are not all empty. All outputs must have empty extents");
