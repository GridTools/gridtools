...
namespace gridtools {
    ...
    namespace _impl_cuda {
        ...
        __global__
        void do_it_on_gpu(LocalDomain const * RESTRICT l_domain, typename Arguments::coords_t const* coords, uint_t const starti, uint_t const startj, uint_t const nx, uint_t const ny) {
