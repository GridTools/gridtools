...
namespace gridtools {
    ...
    struct execute_kernel_functor_cuda {
        ...
        // ctor
        explicit execute_kernel_functor_cuda(
            const local_domain_t &local_domain, const grid_t &grid, const uint_t block_idx_i, const uint_t block_idx_j)
        ...
        void operator()() {
            ...
            typedef run_functor_arguments< RunFunctorArguments::backend_id_t::value,
                cuda_block_size_t,
                ...
                RunFunctorArguments::s_strategy_id > run_functor_arguments_cuda_t;
