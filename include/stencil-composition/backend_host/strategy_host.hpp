    ...
    struct strategy_from_id_host< enumtype::Naive>
    {
        ...
        struct fused_mss_loop
        {
            ...
            static void run(LocalDomainListArray& local_domain_lists, const Grid& grid_)
            {
                ...
                gridtools::for_each<iter_range> (mss_functor<MssComponentsArray, Grid, LocalDomainListArray, BackendId, enumtype::Naive> (local_domain_lists, grid_,0,0));
            }
        };
        ...
        struct mss_loop
        {
            ...
            static void run(const LocalDomain& local_domain, const Grid& grid_, const uint_t bi, const uint_t bj)
            {
                ...
                GRIDPREFIX::execute_kernel_functor_host<RunFunctorArgs>(local_domain, grid_)();
            }
        };
    ...
    struct strategy_from_id_host <enumtype::Block>
    {
        ...
        struct fused_mss_loop
        {
            ...
            static void run(LocalDomainListArray& local_domain_lists, const Grid& grid_)
            {
                ...
                uint_t n = grid_.i_high_bound() - grid_.i_low_bound();
                uint_t m = grid_.j_high_bound() - grid_.j_low_bound();
                ...
                #pragma omp for nowait
                    for (uint_t bi = 0; bi <= NBI; ++bi) {
                        for (uint_t bj = 0; bj <= NBJ; ++bj) {
                            gridtools::for_each<iter_range> (mss_functor<MssComponentsArray, Grid, LocalDomainListArray, BackendId, enumtype::Block> (local_domain_lists, grid_,bi,bj));
                        }
                    }
                }
            }
        ...
        struct mss_loop
        {
            ...
            static void run(const LocalDomain& local_domain, const Grid& grid_, const uint_t bi, const uint_t bj)
            {
                ...
                uint_t first_i = bi*BI+grid_.i_low_bound();
                uint_t first_j = bj*BJ+grid_.j_low_bound();
                ...
                GRIDPREFIX::execute_kernel_functor_host<RunFunctorArgs>(local_domain, grid_, first_i, first_j, last_i, last_j, bi, bj)();
            }
        };
