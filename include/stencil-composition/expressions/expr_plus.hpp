namespace gridtools{
    ...
    namespace evaluation{
        ...
        auto
        //float_type
        static constexpr value(IterateDomain const& it_domain
                                    , expr_derivative<expr_plus<ArgType1, ArgType2> > const& arg)
             -> decltype(it_domain(expr_derivative<ArgType1>(arg.first_operand.first_operand)) + it_domain( expr_derivative<ArgType2>(arg.first_operand.second_operand) ))
        {
            return it_domain(expr_derivative<ArgType1>(arg.first_operand.first_operand)) + it_domain( expr_derivative<ArgType2>(arg.first_operand.second_operand) );}
        ...
        GT_FUNCTION
        auto static constexpr value(IterateDomain const& it_domain
                                           , expr_derivative<expr_plus<ArgType1, FloatType> > const& arg)
            -> decltype(it_domain(arg.first_operand) + arg.second_operand) {
