    ...
    namespace evaluation{
        ...
        */
        ...
        auto static constexpr value(IterateDomain const& it_domain
                                    , expr_derivative<expr_pow<ArgType1, Exponent> > const& arg)
            -> decltype( it_domain(arg.first_operand) ) {
            return (it_domain(expr_pow<ArgType1, Exponent-1>(arg.first_operand) * expr_derivative<ArgType1>(arg.first_operand)));}
