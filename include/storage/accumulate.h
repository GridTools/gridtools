...
This files also contains the implementation of some constexpr operations which can be used in the accumulator, and of a vec_max operator computing the maximum of a compile time sequence of integers.
 */
namespace gridtools{
