...
namespace gridtools{
    ...
    struct align{
        ...
        struct apply_tt{
            ...
            static const uint_t value = AlignmentBoundary && has_stride_one ? Dimension+AlignmentBoundary-(Dimension%AlignmentBoundary) : Dimension;
        };
        ...
        struct do_align{
            ...
            static constexpr uint_t apply(uint_t const& dimension){
                //the stride is one when the value in the layout vector is the highest
                return AlignmentBoundary && has_stride_one ? dimension+AlignmentBoundary-(dimension%AlignmentBoundary) : dimension;
            }
        };
